...
public class UserController {
    ...
    @PutMapping(value = "update_user/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = "delete_user/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "user_password-reset/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "user_password-change", produces = MediaType.APPLICATION_JSON_VALUE)
