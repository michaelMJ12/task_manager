...
public class ApplicationStartupEvent implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(final ApplicationReadyEvent event) {
        List<String> defaultRoles = Arrays.asList("ADMIN", "PROJECTMANAGER", "TEAMMEMBER");
        String defaultEmail = "rotimimichaeljames@gmail.com";
    ...
    private void createDefaultUser(String defaultEmail) {
        ...
        userEntity.setFirstname("Rotimi");
        userEntity.setLastname("James");
        userEntity.setEmail(defaultEmail);
        userEntity.setPhone("09158865852");
        userEntity.setPassword(passwordEncoder.encode("rotimi"));
