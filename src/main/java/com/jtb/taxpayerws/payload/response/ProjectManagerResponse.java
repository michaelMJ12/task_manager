...
public class ProjectManagerResponse {
    ...
    public ProjectManagerResponse(Long id, String firstName, String middleName, String lastName, String department, String assignProjectName, String projectStatus, String projectComplete, LocalDate projectStartDate, LocalDate projectFinishDate) {
        this.id = id;
