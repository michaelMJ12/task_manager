...
public class TaskResponse {
    ...
    public TaskResponse(Long id, String taskDescription, String taskStatus, String category, String taskAssignTo, String percentageComplete, LocalDate taskStartDate, LocalDate taskFinishDate, LocalTime taskHoursDuration, LocalDate taskDateDuration) {
        this.id = id;
